package ru.martinov.connector.quartz.model;
...
public class TriggerDescriptor {
    ...
    public TriggerDescriptor setTriggerState(final Trigger.TriggerState triggerState) {
     ...
     */
    public static TriggerDescriptor buildDescriptor(Trigger trigger, Trigger.TriggerState triggerState) {
